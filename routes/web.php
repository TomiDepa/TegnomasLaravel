...
Route::resource('/users',UserController::class)->middleware('rol:Admin');
Route::get('/users/{user}', 'App\Http\Controllers\UserController@show')->name('users.show')->middleware('rol:Admin');
