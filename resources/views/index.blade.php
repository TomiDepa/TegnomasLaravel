...
<main class="backgroundDegrade">
    ...
    <section class="infoIndex">
        <section class="descrIndex">
            ...
            <a href="/nosotros" class="boton">LEER MAS</a>
        </section>
        <section class="imgIndex">
            <a href="/productos"><img src="{{ asset('img/celu.png') }}" alt="Iphone 14 Pro Max" class="img-fluid"></a>
            <a href="/productos"><img src="{{ asset('img/auris.png') }}" alt="Auriculares" class="img-fluid"></a>
            <a href="/productos"><img src="{{ asset('img/mando.png') }}" alt="Mando Xbox" class="img-fluid"></a>
        </section>
    </section>
</main>
